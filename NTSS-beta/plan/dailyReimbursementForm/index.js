  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control59_MOBJiQ: function (elem) {
      ;if (elem) {
        ...
        }data.data[6] = ['报销凭证', basic4.querySelectorAll('tr').length + '张', basic4.querySelector('tr') && basic4.querySelector('tr').querySelectorAll('td')[0].textContent];for (var i = 0; i < basic4.querySelectorAll('tr').length; i++) {
    ...
    getTemplate_uiControl57_aecEHU: function () {
