    ...
    onTargetLoad: function(aWin, doc){
      setTimeout(function(){
        ...
        $.ajax({
			...
			// if(topWin.EAPI.isIOS() && aWin.location.href == 'http://59.110.171.69:31044/'){
      ...
      var port= aWin.location.port;
        ...
        if (topWin.EAPI.isAndroid()) {
          ...
          $.ajax({
            ...
            type: 'post',
            data: {Username:userName,Password:password || localStorage.password },
            success:function(data){
          ...
          // $.ajax({
          //   url: 'http://59.110.171.69:31044/names.nsf?Login',
          //   type: 'post',
