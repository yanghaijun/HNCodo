...
gulp.task('31045TO31044', async()=>{
    gulp.src(['**/*', '!./gulpfile.js', '!./lib/images/**/*', '!./**/*.png', '!./**/css/**/*', '!/**/*.ico'])
        //OA http://123.56.221.127:20070 环境转移 http://123.56.221.127:30011 环境
        .pipe(replace(/http:\\{2}\/\\{2}\/59\\{2}.110\\{2}.171\\{2}.69:31045/gm, 'http:\\\\/\\\\/59\\\\.110\\\\.171\\\\.69:31044'))
        .pipe(replace(/59\.110\.171\.69:31045/gm, '59.110.171.69:31044'))
        .pipe(gulp.dest('./'));
});      
