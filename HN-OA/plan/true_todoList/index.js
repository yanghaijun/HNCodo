  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control39_W4gLzy: function (elem) {
      if (!elem) {
        ...
        var a = [];var title = trs[i].querySelectorAll("td") && trs[i].querySelectorAll("td")[2].textContent;var titles = trs[i].querySelectorAll("td") && trs[i].querySelectorAll("td")[3].textContent;var person = trs[i].querySelectorAll("td") && trs[i].querySelectorAll("td")[6].textContent;var time = trs[i].querySelectorAll("td") && trs[i].querySelectorAll("td")[7].textContent;if (title == '测试收文流程' || title == '测试发文流程' || title == '测试签报' || title == '测试部门会议纪要' || title == '测试通知公告' || title == '测试部门发文' || title == '测试人员变动' || title == '测试公司会议纪要' || title == '测试考勤审批' || title == '测试请假审批' || title == '付款测试' || title == '测试工作联系单' || title == '测试会议通知' || title == '测试车辆管理' || title == '测试信息变更' || title == '内发测试' || title == '公司收文' || title == '公司签报' || title == '公司发文' || title == '部门发文' || title == '内发子流程' || title == '通知公告' || title == '公司会议纪要' || title == '部门会议纪要' || title == '信息变更管理' || title == '考勤审批' || title == '请假审批' || title == '付款申请' || title == '工作联系单' || title == '会议（培训）通知') {
      ...
      if (data.eventType == "click") {
        ...
        var index = parseInt(data.customData);var a = [];var trs = elem.querySelectorAll("tr");for (var i = 0; i < trs.length; i++) {
          var title = trs[i].querySelectorAll("td") && trs[i].querySelectorAll("td")[2].textContent;if (title == '测试收文流程' || title == '测试发文流程' || title == '测试签报' || title == '测试部门会议纪要' || title == '测试通知公告' || title == '测试部门发文' || title == '测试人员变动' || title == '测试公司会议纪要' || title == '测试考勤审批' || title == '测试请假审批' || title == '付款测试' || title == '测试工作联系单' || title == '测试会议通知' || title == '测试车辆管理' || title == '测试信息变更' || title == '内发测试' || title == '公司收文' || title == '公司签报' || title == '公司发文' || title == '部门发文' || title == '内发子流程' || title == '通知公告' || title == '公司会议纪要' || title == '部门会议纪要' || title == '信息变更管理' || title == '考勤审批' || title == '请假审批' || title == '付款申请' || title == '工作联系单' || title == '会议（培训）通知') {
            a.push(trs[i]);
          }
