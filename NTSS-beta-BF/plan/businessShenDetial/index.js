(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control84_pIJH4T: function (elem) {
      ;if (!elem) {
        return false;
      } //console.log(elem)
      return elem.ownerDocument.querySelector('.breadcrumb').querySelector('span').textContent;
    },
    doAction_uiControl73_ICIDui: function (data, elem) {
      if (data.eventType == 'click') {
        elem.ownerDocument.querySelector('#_easyui_tree_9').click();ysp.appMain.showLoading();setTimeout(function () {
          ysp.appMain.hideLoading();
        }, 2000);
      }
    },
    getTemplate_uiControl73_ICIDui: function () {
    ...
    getData_control90_p9qkLN: function (elem) {
      ;if (elem) {
    ...
    doAction_uiControl74_Er2MIs: function (data, elem) {
      if (data.eventType == 'preview') {
        debugger;var _url = data.dataCustom[0];var type = '.' + data.dataCustom[1].replace(/\./, "");var _name = data.dataCustom[2];var cookies = elem.ownerDocument.cookie;var options = { docName: '文档', docType: type, downloadUrl: _url };if (ysp.appMain.isIOS()) {
    ...
    getTemplate_uiControl74_Er2MIs: function () {
    ...
    doAction_uiControl75_wvn4HL: function (data, elem) {
      //提交
      if (data.eventType == 'submit') {
        for (var i = 0; i < elem.ownerDocument.querySelectorAll('.input_table')[0].querySelectorAll('button').length; i++) {
          if (elem.ownerDocument.querySelectorAll('.input_table')[0].querySelectorAll('button')[i].textContent == "同 意") {
    ...
    getTemplate_uiControl75_wvn4HL: function () {
    ...
    getData_control102_NMNKql: function (elem) {
      ;if (!elem) {
        return false;
    ...
    doAction_uiControl85_tfLUbv: function (data, elem) {
    ...
    getTemplate_uiControl85_tfLUbv: function () {
