  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl5_Qqv3JO: function (data, elem) {
      ...
      if (data.eventType == 'clickIdea') {
        ysp.appMain.showLoading();var text = data.customData.text;var name = data.customData.name;var basics = elem.children;if (text == "信息项目结转") {
          if (name == "提交") {
            alert('提交成功');
          }if (name == "驳回") {
            alert('驳回成功');
      ...
      if (data.eventType == 'fujianCommit') {
        ...
        var index = data.customData.value;var text = data.customData.text;var basics = elem.children;var keyIdOk;var keyIdNOk;if (text == '煤炭合同') {
          if (basics[4]) {
    ...
    getTemplate_uiControl2_7R9TUx: function () {
      var selfTemplate = "module.exports = React.createClass({\n  handlerClick(){\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:'click'\n      })\n    }\n  },\n  render: function() {\n    return (\n      <div>\n      \t{\n          localStorage.workflows == \"\u4FE1\u606F\u9879\u76EE\u7ED3\u8F6C\" ? <div onClick={this.handlerClick.bind(this)}>\n            \u70B9\u51FB\u663E\u793A\u6DFB\u52A0\u9644\u4EF6\n          </div> : ''\n        }\n      </div>\n      \n    )\n  }\n});";
    ...
    getData_control10_GMvaHF: function (elem) {
      ...
      var data = { flag: [], chosefile: [], fujianContent: [] };var ids = elem && elem.getAttribute("id");var flag = ids && ids == "FDOE.TaskExecutionView.AttachmentsTray" ? true : false; //querySelector('#FDOE.TaskExecutionView.AttachmentsTray') ? true : false;
      data.flag.push(flag);var childrens = elem && elem.children;var divs = childrens && childrens[1] && childrens[1].querySelector('div[id="FDOEEEMN.AttachmentListView.ToolBarPopinAddAttachment_Content"]');var val = divs && divs.querySelectorAll("input")[0].value;var str = val && val.split("\\");var strTitle = str && str[str.length - 1];data.chosefile.push(strTitle); //显示附件
    ...
    doAction_uiControl6_yrBfrq: function (data, elem) {
      if (data.eventType == 'click') {
        var name = data.customData;var childrens = elem && elem.children;if (name == "添加附件") {
          ...
          var divs = childrens && childrens[1] && childrens[1].querySelector('div[id="FDOEEEMN.AttachmentListView.ToolBarPopinAddAttachment_Content"]');divs && divs.querySelectorAll("input")[0].click();
        } else {
          var divs = childrens && childrens[1] && childrens[1].querySelector('div[id="FDOEEEMN.AttachmentListView.ToolBarPopinAddAttachment_Content"]');divs && divs.querySelector('a[id="FDOEEEMN.AddAttachmentView.ButtonUpload"]').click();
        }
      }
    },
    getTemplate_uiControl6_yrBfrq: function () {
      var selfTemplate = "module.exports = React.createClass({\n  handlerClick(e){\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:'click',\n        data:e.target.dataset.name\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData || [];\n    return (\n      <div>\n        <div onClick={this.handlerClick.bind(this)} data-name=\"\u6DFB\u52A0\u9644\u4EF6\">\u6DFB\u52A0\u9644\u4EF6</div>\n        <div onClick={this.handlerClick.bind(this)} data-name=\"\u9009\u62E9\u6587\u4EF6\">\u9009\u62E9\u6587\u4EF6</div>\n        <div>\n          <span>\u6240\u9009\u6587\u4EF6\uFF1A</span>\n          <span>{data && data.chosefile}</span>\n        </div>\n        <div onClick={this.handlerClick.bind(this)} data-name=\"\u786E\u5B9A\">\u786E\u5B9A</div>\n        {\n          data && data.fujianContent && data.fujianContent.length == 0 ? <div style={{'color':'red','text-align':'center'}}>\u6682\u65E0\u9644\u4EF6\uFF01\uFF01</div> :\n            data.fujianContent.map(function(d,i){\n              return(\n                <div className=\"ysp-deatil-fujian-content\">\n                  <div>{d[0]}</div>\n                  <div>\n                    <span>{d[1]}</span>\n                    <span>{d[2]}</span>\n                  </div>\n                  <div>\n                    <span>{d[3]}</span>\n                    <span>{d[5]}</span>\n                  </div>\n                </div>\n              )\n            })\n          }\n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n  handlerClick: function handlerClick(e) {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'click',\n        data: e.target.dataset.name\n      });\n    }\n  },\n\n  render: function render() {\n    var data = this.props.customData || [];\n    return React.createElement(\n      \"div\",\n      null,\n      React.createElement(\n        \"div\",\n        { onClick: this.handlerClick.bind(this), \"data-name\": \"\\u6DFB\\u52A0\\u9644\\u4EF6\" },\n        \"\\u6DFB\\u52A0\\u9644\\u4EF6\"\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.handlerClick.bind(this), \"data-name\": \"\\u9009\\u62E9\\u6587\\u4EF6\" },\n        \"\\u9009\\u62E9\\u6587\\u4EF6\"\n      ),\n      React.createElement(\n        \"div\",\n        null,\n        React.createElement(\n          \"span\",\n          null,\n          \"\\u6240\\u9009\\u6587\\u4EF6\\uFF1A\"\n        ),\n        React.createElement(\n          \"span\",\n          null,\n          data && data.chosefile\n        )\n      ),\n      React.createElement(\n        \"div\",\n        { onClick: this.handlerClick.bind(this), \"data-name\": \"\\u786E\\u5B9A\" },\n        \"\\u786E\\u5B9A\"\n      ),\n      data && data.fujianContent && data.fujianContent.length == 0 ? React.createElement(\n        \"div\",\n        { style: { 'color': 'red', 'text-align': 'center' } },\n        \"\\u6682\\u65E0\\u9644\\u4EF6\\uFF01\\uFF01\"\n      ) : data.fujianContent.map(function (d, i) {\n        return React.createElement(\n          \"div\",\n          { className: \"ysp-deatil-fujian-content\" },\n          React.createElement(\n            \"div\",\n            null,\n            d[0]\n          ),\n          React.createElement(\n            \"div\",\n            null,\n            React.createElement(\n              \"span\",\n              null,\n              d[1]\n            ),\n            React.createElement(\n              \"span\",\n              null,\n              d[2]\n            )\n          ),\n          React.createElement(\n            \"div\",\n            null,\n            React.createElement(\n              \"span\",\n              null,\n              d[3]\n            ),\n            React.createElement(\n              \"span\",\n              null,\n              d[5]\n            )\n          )\n        );\n      })\n    );\n  }\n});";
    }
  }, "detail");
})(window, ysp);