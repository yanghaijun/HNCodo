(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control91_ZUlWyK: function (elem) {
      ;
    },
    doAction_uiControl88_sJcSRD: function (data, elem) {
      //elem.ownerDocument.defaultView.close();
      //history.go(-1);
      var _web = localStorage.allWeb;var port = elem.ownerDocument.defaultView.location.port;elem.ownerDocument.location.href = 'http://59.110.171.69:' + port + '/' + _web + '/MoaWebConfigSet.nsf/fomBoxList4?OpenForm&v=viwInBox&d=MoaWebOffice.nsf';
    },
    getTemplate_uiControl88_sJcSRD: function () {
