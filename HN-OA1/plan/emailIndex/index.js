(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control50_2BeSZd: function (elem) {
      setTimeout(function () {
        //ext-gen3
        debugger;var demoUrl = elem.ownerDocument.defaultView.location.href;var urlIP = demoUrl.split("afmail.nsf")[0]; // var el = elem.querySelectorAll('frame') && elem.querySelectorAll('frame')[1].contentDocument.documentElement.querySelector("#ext-gen3");
