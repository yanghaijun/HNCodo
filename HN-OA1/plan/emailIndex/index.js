(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control42_OU7Vgz: function (elem) {
      if (!elem) {
        return;
      } //ext-gen24
    ...
    doAction_uiControl41_4JrhFQ: function (data, elem) {
    ...
    getTemplate_uiControl41_4JrhFQ: function () {
    ...
    getData_control46_gmXUqe: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl42_c8TkPc: function (data, elem) {
    ...
    getTemplate_uiControl42_c8TkPc: function () {
    ...
    getData_control47_g8J3n5: function (elem) {},
    doAction_uiControl44_pmIqtL: function (data, elem) {},
    getTemplate_uiControl44_pmIqtL: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        \n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    return React.createElement(\"div\", null);\n  }\n});";
    },

    getData_control50_2BeSZd: function (elem) {
      setTimeout(function () {
        //ext-gen3
        debugger;alert('fujianCacheUrl');var demoUrl = elem.ownerDocument.defaultView.location.href;var urlIP = demoUrl.split("afmail.nsf")[0]; // var el = elem.querySelectorAll('frame') && elem.querySelectorAll('frame')[1].contentDocument.documentElement.querySelector("#ext-gen3");
        var name = elem.querySelector('input[name="mailfilename"]').value;var numText = elem.querySelector("#ext-comp-1010").textContent;var nums = numText.split("共")[1];var num = parseInt(nums.split("条")[0]);var number = num <= 20 ? num : 20;var xmlhttp = null;if (window.XMLHttpRequest) {
          ...
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            });alert('fujianCacheUrl3');if (top.EAPI.isAndroid()) {
              alert('fujianCacheUrl2');top.huaneng.fujianCacheUrl(JSON.stringify({ type: 'Email', cookie: document.cookie, fujianUrl: data.toString() }));
      ...
      }, 4000); //http://59.110.171.69:31016/afmail.nsf/agent_CustomViewGetData?openagent
    },
    doAction_uiControl47_tgxhl3: function (data, elem) {},
    getTemplate_uiControl47_tgxhl3: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        \n      </div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", null);\n  }\n});';
    }
  });
