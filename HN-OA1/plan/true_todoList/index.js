  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control39_W4gLzy: function (elem) {
      ;if (!elem) {
        ...
        if (title.indexOf('收文') != -1 || title.indexOf('发文') != -1 || title.indexOf('签报') != -1 || title.indexOf('会议') != -1 || title.indexOf('车辆') != -1 || title.indexOf('信息变更') != -1 || title.indexOf('考勤') != -1 || title.indexOf('请假') != -1 || title.indexOf('付款') != -1 || title.indexOf('工作联系单') != -1 || title.indexOf('内发') != -1 || title.indexOf('便函') != -1) {
