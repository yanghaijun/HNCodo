  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control59_MOBJiQ: function (elem) {
      ;if (elem) {
        ...
        //data.data[2] = ['报销类型', '部门费用'];
        data.data[2] = ['报销类型', basic2.querySelectorAll('tr')[1] && basic2.querySelectorAll('tr')[1].querySelectorAll('td')[1] && basic2.querySelectorAll('tr')[1].querySelectorAll('td')[1].textContent.trim()];data.data[3] = ['单据号', basic1.querySelectorAll('tr')[2].children[1].textContent.replace(/\s+/g, '')];if (basic2.querySelectorAll('tr')[0].querySelectorAll('td')[1].querySelector('input')) {
