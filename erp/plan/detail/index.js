  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl5_Qqv3JO: function (data, elem) {
      ...
      if (data.eventType == 'fujianLook') {
        var title = data.customData.title;var cookies = elem.ownerDocument.cookie;alert("title=" + title);alert("cookie=" + cookies);
      } //附件添加
