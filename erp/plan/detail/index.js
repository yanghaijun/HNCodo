(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control8_81xko5: function (elem) {
      ...
      var SP; //审批历史
      if (text) {
        if (text == "其它费用结算" || text == '燃煤结算' || text == "燃料合同作废申请" || text == "燃煤临购计划" || text == "燃煤销售结算") {
          if (text == "燃煤临购计划") {
            FJ = basics[1] && basics[1].querySelector('table[id="FDOEEFPDBOMAACHHGJLN.AttachCompView.Tray"]');
          } else if (text == '燃煤结算' || text == "燃料合同作废申请" || text == "燃煤销售结算") {
      ...
      } /***审批意见****/var textareaValue = YJ && YJ.querySelector('textarea') && YJ.querySelector('textarea').value;data.idea.push(textareaValue);var inputValue = YJ && YJ.querySelectorAll('input')[0] && YJ.querySelectorAll('input')[0].value;data.ideaEnding.push(inputValue);var personValue = YJ && YJ.querySelectorAll('input')[2] && YJ.querySelectorAll('input')[2].value;data.ideaPerson.push(personValue); //审批历史
    ...
    doAction_uiControl5_Qqv3JO: function (data, elem) {
      ...
      if (typs == 'clickIdea' || typs == 'fujianAdd' || typs == 'fujianFile' || typs == 'fujianCommit') {
      ...
      if (data.eventType == 'clickIdea') {
        ysp.appMain.showLoading();debugger;if (YJ) {
      ...
      if (data.eventType == 'fujianDelete') {
        ysp.appMain.showLoading();var index = parseInt(data.customData.index); //   var text = data.customData.text;
        //   var basics = elem.children;
        //   if (text == "其它费用结算") {
        //     var FJ = basics[1] && basics[1].children[0].lastElementChild.lastElementChild;
        //   } else if (text == "燃料付款申请单") {
      ...
      if (data.eventType == "fujianAdd") {
        ysp.appMain.showLoading(); //   var text = data.customData;
        //   var basics = elem.children;
        //   if (text == "其它费用结算") {
        //     var FJ = basics[1] && basics[1].children[0].lastElementChild.lastElementChild;
        //     var FJ = basics[1] && basics[1].children[0].lastElementChild.lastElementChild;
