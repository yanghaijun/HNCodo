    ...
    getData_control7_yw9WUw: function (elem) {
      ...
      if (text) {
        if (text == "其它费用结算" || text == '燃煤结算' || text == "燃料合同作废申请" || text == "燃煤临购计划" || text == "燃煤销售结算" || text == "服务验收审批单" || text == "询报价采购管理" || text == "供应商评估结果" || text == "燃煤年度采购计划维护") {
          ...
          var dd = elem.firstElementChild.firstElementChild.firstElementChild;var cc = dd.children[2];var ss = cc.querySelectorAll('div[id="FDOEEFPDBOMAACHH.FundsView.PageHeader"]');FJ = '';YJ = '';SP = ss[ss.length - 1];
        }
