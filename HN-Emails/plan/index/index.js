(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control2_VGeFOG: function (elem) {},
    doAction_uiControl1_xCo6sT: function (data, elem) {},
    getTemplate_uiControl1_xCo6sT: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        \n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    return React.createElement(\"div\", null);\n  }\n});";
    },
    getData_control3_1riqlb: function (elem) {
      setTimeout(function () {
    ...
    doAction_uiControl2_8aKyw7: function (data, elem) {},
    getTemplate_uiControl2_8aKyw7: function () {
      var selfTemplate = "module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        \n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n\n  render: function render() {\n    return React.createElement(\"div\", null);\n  }\n});";
    },
    getData_control4_r4uuZb: function (elem) {
      if (!elem) {
        return;
      } //ext-gen24
    ...
    doAction_uiControl3_2mmCL7: function (data, elem) {
    ...
    getTemplate_uiControl3_2mmCL7: function () {
    ...
    getData_control6_6fgMwA: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl4_fsh66T: function (data, elem) {
    ...
    getTemplate_uiControl4_fsh66T: function () {
