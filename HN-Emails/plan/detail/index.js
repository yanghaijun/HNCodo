(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    getData_control9_xPWkyc: function (elem) {
      if (!elem) {
        return false;
      } //iframe
      ...
      //var text = content[0] && content[0].innerHTML.replace(/&nbsp;/g, '').replace(/\n/g, '').split('<br>');
    ...
    doAction_uiControl7_khbuDf: function (data, elem) {
    ...
    getTemplate_uiControl7_khbuDf: function () {
