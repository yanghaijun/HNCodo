  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control15_hcs1LK: function (elem) {
      if (!elem) {
        ...
        //data.flag.push(true);
        localStorage.setStockStyle = true;
      } else {
        localStorage.setStockStyle = false;
      }return data;
    },
    ...
    getTemplate_uiControl2_7R9TUx: function () {
      var selfTemplate = "import {Component} from 'react';\nexport default class extends Component{\n  constructor(){\n    super();\n    this.state={\n      flag: true\n    }\n  }\n  handlerClick(){\n    ysp.appMain.showLoading();\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:'click'\n      })\n    }\n    this.setState({\n      flag: !this.state.flag\n    })\n  }\n  render(){\n    var data = this.props.customData;\n    return (\n      <div>\n      \t{\n          (data && data == true && localStorage.setStockStyle == \"true\" && localStorage.workflows == \"\u4FE1\u606F\u9879\u76EE\u7ED3\u8F6C\") ? <div onClick={this.handlerClick.bind(this)} className=\"ysp-detail-fujian\">\n            \u70B9\u51FB{this.state.flag ? '\u663E\u793A' : '\u9690\u85CF'}\u9644\u4EF6\n          </div> : ''\n        }\n      </div>\n      \n    )\n  }\n}";
      return "'use strict';\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require('react');\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_Component) {\n  _inherits(_class, _Component);\n\n  function _class() {\n    _classCallCheck(this, _class);\n\n    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this));\n\n    _this.state = {\n      flag: true\n    };\n    return _this;\n  }\n\n  _createClass(_class, [{\n    key: 'handlerClick',\n    value: function handlerClick() {\n      ysp.appMain.showLoading();\n      var handler = this.props.customHandler;\n      if (handler) {\n        handler({\n          eventType: 'click'\n        });\n      }\n      this.setState({\n        flag: !this.state.flag\n      });\n    }\n  }, {\n    key: 'render',\n    value: function render() {\n      var data = this.props.customData;\n      return React.createElement(\n        'div',\n        null,\n        data && data == true && localStorage.setStockStyle == \"true\" && localStorage.workflows == \"\u4FE1\u606F\u9879\u76EE\u7ED3\u8F6C\" ? React.createElement(\n          'div',\n          { onClick: this.handlerClick.bind(this), className: 'ysp-detail-fujian' },\n          '\\u70B9\\u51FB',\n          this.state.flag ? '\u663E\u793A' : '\u9690\u85CF',\n          '\\u9644\\u4EF6'\n        ) : ''\n      );\n    }\n  }]);\n\n  return _class;\n}(_react.Component);\n\nexports.default = _class;";
    },
