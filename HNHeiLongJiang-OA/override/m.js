         ...
         <div class="login_panel">
            ...
            <dl class="login_form">
                ...
                <dd>
                  ...
                  <div class="forget_pw_text">��ס����</div>
                
  </dd>
                
                <dd class="enter_system"><input class="btn_off" onmouseover="this.className='btn_on'" onmouseout="this.className='btn_off'" type="button" value="��¼" id="freeow-show" /></dd>
...
<div class="bottom_fixed">
   ...
   <div class="bottom_blk">
         <span class="bottom_tips">Ϊ���и����õ��û����飬����IE8���ϵ������Ԥ����ϵͳ������ģ����Ҫ������������ؼ����ܲ鿴��<a href="/WebOfficeFrame/syslib.nsf/fomDownloadAttachment?OpenForm" class="down_link" target="_blank">������</a></span>
   </div>
</div>
