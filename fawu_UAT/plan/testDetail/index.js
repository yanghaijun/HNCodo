(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl11_T2tGPA: function (data, elem) {
      ...
      if ('clickIdea' == types) {
        var index = data.customData.index;var spans = AN && AN.querySelectorAll("a"); // for (var k = 0; k < spans.length; k++) {
        //   data.button.push(spans[k].textContent);
        // }
