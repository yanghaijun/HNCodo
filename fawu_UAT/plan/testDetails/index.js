  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control33_rw9IxQ: function (elem) {
      ...
      if (text == "合同审批") {
        ...
        var div = XQ && XQ.querySelector('div[id="FDOEEFPDBOMAACHH.HtAllView.TabStrip1-panel"]');var divs = div && div.querySelectorAll('div[ct="TSITM"]');
    ...
    doAction_uiControl31_kcbuxD: function (data, elem) {
      ...
      if ('clickIdea' == types) {
        debugger;ysp.appMain.showLoading();setTimeout(function () {
          ysp.appMain.hideLoading();
