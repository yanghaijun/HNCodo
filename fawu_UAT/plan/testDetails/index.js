(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control27_p2zAUA: function (elem) {
      if (!elem) {
        return;
      }var data = { flagText: [], bas: [], fujianContent: [], fujianFile: [], fujianFlag: [], history: [], idea: [], ideaEnding: [], ideaPerson: [], button: [], huiqian: [], xiangqing: [] // vv: [],
        // vv1: [],
        // vv2: [],
        // vv3: []
      }; //console.log(elem);
          ...
          if (trs[i].getAttribute('class') == 'lsCLRow') {
            if (trs[i].querySelector('table')) {
              ...
              if (tds[j].getAttribute('sectionid')) {
                var a = [];if (tds[j].querySelector('input')) {
