  ...
  ysp.runtime.Model.extendLoadingModel({
      ...
      if (text == "合同审批") {
        ...
        for (var a = 0; a < trs.length; a++) {
          if (trs[a].getAttribute('udat')) {
            ...
            var c = [];c.push(tdss[2].textContent);data.fujianContent.push(c);
          }
        }
      } else if (text == '技术文件审批') {
    ...
    doAction_uiControl31_kcbuxD: function (data, elem) {
      ...
      if ('clickIdea' == types) {
        ...
        var index = data.customData.index;var idea = data.customData.idea;var title = data.customData.title;var huiqian = data.customData.huiqian;var spans = AN && AN.querySelectorAll("a");if (title == " 退回") {
          if (idea == "") {
          ...
          if (idea == "") {
            ...
            //spans && spans[index].preventDefault();
            //spans && spans[index].stopPropagation();
            spans && spans[index].click();
          }
        } else if (title == " 发起会签") {
          if (huiqian.length == 0) {
