    ...
    getData_control11_nmdcG4: function (elem) {
      ...
      var type = data.eventType;var value = data.customData.value;var title = data.customData.title;if (type == 'change') {
        ...
        var ass = elem.querySelectorAll('a');if (title == '确认') {
          ...
          ass && ass[1].click();elem.ownerDocument.defaultView.parent.close();elem.ownerDocument.defaultView.open('http://ihn.chng.com.cn:10008/webdynpro/resources/sap.com/pb/PageBuilder?PagePath=pcd%3Aportal_content%2Fcom.hnjt.HNJT%2Fcom.hnjt.XTGL%2Fcom.hnjt.Role%2FZHNJT_CLM_TY001%2FGRGZ1%2F____%2FNew_Page&sap-ext-sid=' + top.sap_sid);
        }
      }
    },
