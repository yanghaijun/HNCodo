(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control3_LrtITJ: function (elem) {
      setTimeout(function () {
        var name = elem.querySelector('input[name="mailfilename"]').value; //    var numText = elem.querySelector("#main_center_frame").contentDocument.documentElement.querySelector("#ext-comp-1010").textContent;
        console.log(elem.querySelector("#main_center_frame")); //   var nums = numText.split("共")[1];
