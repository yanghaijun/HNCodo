(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getData_control4_bkU90V: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl4_q4BkFz: function (data, elem) {
    ...
    getTemplate_uiControl4_q4BkFz: function () {
    ...
    getData_control6_OPQsbI: function (elem) {
      if (!elem) {
        return;
    ...
    doAction_uiControl5_E2uAXz: function (data, elem) {
    ...
    getTemplate_uiControl5_E2uAXz: function () {
    ...
    getData_control16_LEIhJn: function (elem) {
      setTimeout(function () {
        var el = elem.querySelectorAll('frame') && elem.querySelectorAll('frame')[1].contentDocument.documentElement.querySelector("#ext-gen3");var name = el.querySelector('input[name="mailfilename"]').value;var numText = el.querySelector("#ext-comp-1010").textContent;var nums = numText.split("共")[1];var num = nums.split("条")[0];var xmlhttp = null;if (window.XMLHttpRequest) {
          xmlhttp = new XMLHttpRequest();
        } else if (window.ActiveXObject) {
          xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
        }xmlhttp.onreadystatechange = function () {
    ...
    doAction_uiControl12_aFGI9c: function (data, elem) {},
    getTemplate_uiControl12_aFGI9c: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    return (\n      <div>\n        \n      </div>\n    )\n  }\n});';
      return '"use strict";\n\nmodule.exports = React.createClass({\n  displayName: "exports",\n\n  render: function render() {\n    return React.createElement("div", null);\n  }\n});';
    }
  }, "index");
