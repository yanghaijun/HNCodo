  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl0_UK1PTt: function (data, elem) {
      if (data.eventType == 'nameValue') {
        ...
        //       div.innerHTML = xmlhttp.responseText; //elem.ownerDocument.location.href = 'http://59.110.171.69:31009/afmail.nsf/v_Key_frmView/2781985C4B886B5348257EEB0024C19F?OpenDocument&RefMenuID=7907BC8CBEEF621648257EEB0025FDE3&RefMenuTitle=%E6%94%B6%E4%BB%B6%E7%AE%B1#';
        //     }
        //   };
        //   xmlhttp.open("post", "http://59.110.171.69:31009/names.nsf?Login");
        //   xmlhttp.setRequestHeader("content-type", "application/x-www-form-urlencoded");
        //   xmlhttp.send("username=80086350&password=Chng1234&redirectto=/afmail.nsf/frmWebMailExt_HNMail?OpenForm");
      }
    },
