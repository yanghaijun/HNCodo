(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    getTemplate_uiControl8_a0ktAM: function () {
      var selfTemplate = 'module.exports = React.createClass({\n  render: function() {\n    var data =this.props.customData;\n    var scorllH =document.body.clientHeight-250+\'px\';\n    var scorllT =document.body.clientHeight-370+\'px\';\n    if(data){\n    return (\n      <div className=\'d_detail\'  style={{\'height\':scorllH}}>\n        {data&&data.shujuTitle&&data.shujuTitle.map(function(dt,dl){\n          return (<div className=\'d_detailTitle\' style={{\'height\':scorllT,\'overflow\':\'scroll\'}}>\n              <div>{dt.postMan}</div>\n              <div>{dt.postTime}</div>\n              <div>{dt.saveMan}</div>\n              <div>{dt.postRecman}</div>\n              <div>{dt.postAttachment}</div>\n              <h6>{dt.title}</h6>\n           </div>)\n        })}\n        <div  className=\'d_fujian\' style={{\'height\':\'120px\',\'overflow\':\'scroll\'}}>\n          {data&&data.fujian&&data.fujian.map(function(j,q){\n            return (<div>\n                <span className={data.fujianlogo&&data.fujianlogo[q]==\'p\'?\'p\':(data.fujianlogo[q]==\'w\'?\'w\':\'e\')}></span>\n                <span>{j}</span>\n                <span></span>\n                <span></span>\n                <span></span>\n            </div>)\n          })}\n        </div>\n      </div>\n    )\n      }else {\n        return <div>\u52A0\u8F7D\u4E2D...</div>\n      }\n  }\n});';
      return '\'use strict\';\n\nmodule.exports = React.createClass({\n  displayName: \'exports\',\n\n  render: function render() {\n    var data = this.props.customData;\n    var scorllH = document.body.clientHeight - 250 + \'px\';\n    var scorllT = document.body.clientHeight - 370 + \'px\';\n    if (data) {\n      return React.createElement(\n        \'div\',\n        { className: \'d_detail\', style: { \'height\': scorllH } },\n        data && data.shujuTitle && data.shujuTitle.map(function (dt, dl) {\n          return React.createElement(\n            \'div\',\n            { className: \'d_detailTitle\', style: { \'height\': scorllT, \'overflow\': \'scroll\' } },\n            React.createElement(\n              \'div\',\n              null,\n              dt.postMan\n            ),\n            React.createElement(\n              \'div\',\n              null,\n              dt.postTime\n            ),\n            React.createElement(\n              \'div\',\n              null,\n              dt.saveMan\n            ),\n            React.createElement(\n              \'div\',\n              null,\n              dt.postRecman\n            ),\n            React.createElement(\n              \'div\',\n              null,\n              dt.postAttachment\n            ),\n            React.createElement(\n              \'h6\',\n              null,\n              dt.title\n            )\n          );\n        }),\n        React.createElement(\n          \'div\',\n          { className: \'d_fujian\', style: { \'height\': \'120px\', \'overflow\': \'scroll\' } },\n          data && data.fujian && data.fujian.map(function (j, q) {\n            return React.createElement(\n              \'div\',\n              null,\n              React.createElement(\'span\', { className: data.fujianlogo && data.fujianlogo[q] == \'p\' ? \'p\' : data.fujianlogo[q] == \'w\' ? \'w\' : \'e\' }),\n              React.createElement(\n                \'span\',\n                null,\n                j\n              ),\n              React.createElement(\'span\', null),\n              React.createElement(\'span\', null),\n              React.createElement(\'span\', null)\n            );\n          })\n        )\n      );\n    } else {\n      return React.createElement(\n        \'div\',\n        null,\n        \'\\u52A0\\u8F7D\\u4E2D...\'\n      );\n    }\n  }\n});';
    }
  }, "detail");
})(window, ysp);