(function (win, ysp) {
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl7_Kw2Tcg: function (data, elem) {
      if (data.eventType == 'click') {
        elem.ownerDocument.querySelector('table[id="FDOEEFPDBOMAACHH.HtAllView.ToolBar2"]') && elem.ownerDocument.querySelector('table[id="FDOEEFPDBOMAACHH.HtAllView.ToolBar2"]').querySelector("a").click();
      }
    },
    getTemplate_uiControl7_Kw2Tcg: function () {
      var selfTemplate = "module.exports = React.createClass({\n  handlerClick(){\n    var handler = this.props.customHandler;\n    if(handler){\n      handler({\n        eventType:'click'\n      })\n    }\n  },\n  render: function() {\n    var data = this.props.customData || [];\n    return (\n      <div>\n        <div className=\"liuchenglishi\">\u5BA1\u6279\u5386\u53F2</div>\n        <div className=\"liuchenglishianniu\" onClick={this.handlerClick.bind(this)}>\u83B7\u53D6\u5BA1\u6279\u5386\u53F2\u6570\u636E</div>\n        <div>\n          {\n            data && data.map(function(d,i){\n              return(\n              \t<div className='liuchenglishishuju'>\n                  <div>{d.liucheng}</div>\n                  <div>{d.zhuangtai}</div>\n                  <div>{d.chuliren}</div>\n                  <div>{d.chulirengangwei}</div>\n                  <div>{d.chuliyijian}</div>\n                  <div>{d.chulijieguo}</div>\n                  <div>{d.chulishijian}</div>\n                </div>\n              )\n            })\n          }\n        </div>\n      </div>\n    )\n  }\n});";
      return "\"use strict\";\n\nmodule.exports = React.createClass({\n  displayName: \"exports\",\n  handlerClick: function handlerClick() {\n    var handler = this.props.customHandler;\n    if (handler) {\n      handler({\n        eventType: 'click'\n      });\n    }\n  },\n\n  render: function render() {\n    var data = this.props.customData || [];\n    return React.createElement(\n      \"div\",\n      null,\n      React.createElement(\n        \"div\",\n        { className: \"liuchenglishi\" },\n        \"\\u5BA1\\u6279\\u5386\\u53F2\"\n      ),\n      React.createElement(\n        \"div\",\n        { className: \"liuchenglishianniu\", onClick: this.handlerClick.bind(this) },\n        \"\\u83B7\\u53D6\\u5BA1\\u6279\\u5386\\u53F2\\u6570\\u636E\"\n      ),\n      React.createElement(\n        \"div\",\n        null,\n        data && data.map(function (d, i) {\n          return React.createElement(\n            \"div\",\n            { className: \"liuchenglishishuju\" },\n            React.createElement(\n              \"div\",\n              null,\n              d.liucheng\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.zhuangtai\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.chuliren\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.chulirengangwei\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.chuliyijian\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.chulijieguo\n            ),\n            React.createElement(\n              \"div\",\n              null,\n              d.chulishijian\n            )\n          );\n        })\n      )\n    );\n  }\n});";
    }
  }, "detail");
})(window, ysp);